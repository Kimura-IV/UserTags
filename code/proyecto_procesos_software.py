...
if id.isdigit () != True:
  ...
  if page.status_code == 404:
    ...
    if len (npag) == 0:
      ...
      lbls.clear ()
      nmbrs.clear ()
      print ("\n{0}[{3}*{0}]{2} Cargando Etiquetas Del Usuario. [PAGINA(S): 1]".format(GREEN, END, CYAN, RED, WHITE))
    else:
      ...
      for b in range (int (npag [int (len (npag))-2])):
        ...
        lbls.clear ()
        nmbrs.clear ()
        stdout.write ("\r{0}[{3}*{0}]{2} Cargando Etiquetas Del Usuario. [PAGINA(S): %d]".format(GREEN, END, CYAN, RED, WHITE) % num)
        stdout.flush ()
